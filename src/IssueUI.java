...
public class IssueUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Book issue form - Library Management System");
        ...
        setBounds((screenSize.width-641)/2, (screenSize.height-488)/2, 641, 488);
    ...
    private void jList2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jList2MouseClicked
        ...
        try {
            ...
            if (rs1.next()) {
                ...
                JOptionPane.showMessageDialog(null, "Record does not found in Lib dent table");
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, e.getMessage());
        }
